...
# verify the artifact locally before cutting a release.
set -euo pipefail
...
# Exclude build/preview.js — that's the local dev preview host, not part of
# the Figma plugin bundle. CI doesn't produce it; keep parity here.
